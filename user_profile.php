...
if (!isset($_GET["user"])) {
    ...
    if (isset($_GET["post"])) {
        ...
        if (isset($_GET["search"])) {
            $posts = $blogpost->searchUserPosts($id, $_GET["search"]);
        }
    }
}
?>
...
<head>
    ...
    <title>Pen Master | User Profile</title>
</head>
        ...
        ?>
            <section class="card rounded-6 w-100 m-2 p-3">
                <div class="d-flex gap-3 justify-content-between">
                    ...
                    <h2 class="align-self-center"><?= $userEntry["name"] ?></h2>
                    <div></div>
                </div>
                <p><?= $userEntry["bio"] ?></p>
            </section>
            ...
            ?>
                <section class="card rounded-6 w-100 m-2 float-start">
                    <div class="card-body">
                        ...
                        <a class="btn btn-primary text-capitalize" href="?user=<?= $_GET["user"] ?>&post=<?= $post['id'] ?>">continue reading</a>
                    </div>
                </section>
            <?php
            }
